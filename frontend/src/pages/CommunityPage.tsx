...
export default function CommunityPage() {
  ...
  return <div className='space-y-4'>
    ...
    {noData && <p className='text-sm text-slate-400'>Schreibe einige Nachrichten im Twitch Chat und lade danach neu.</p>}<List title='Top Topics' rows={radar.topTopics} render={(x:any)=><span>{x.topic} ({x.count})</span>} />
